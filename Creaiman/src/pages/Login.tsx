    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12">
      ...
      >
        ...
        <div className="glass-strong rounded-3xl p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="absolute -top-20 -right-20 w-40 h-40 bg-violet/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-pink/20 rounded-full blur-3xl" />
          ...
          <div className="relative z-10">
            ...
            <p className="font-body text-muted-foreground text-center mb-8">
              Sign in to your CreAIman account
            </p>
            ...
            <form className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="#" className="text-sm text-pink hover:text-pink-light transition-colors font-body">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
              ...
              {/* Submit Button */}
              <MagneticButton variant="hero" className="w-full" size="lg">
                Sign In
            ...
            <p className="text-center text-muted-foreground font-body mt-8">
              ...
              <Link to="/signup" className="text-pink hover:text-pink-light transition-colors font-semibold">
                Create one
              </Link>
            </p>
          </div>
